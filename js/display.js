...
massiveReplaceString += '<div class="talentwrap1"><div class="talentwrap2"><table border = "0" cellpadding = "5" cellspacing = "0"><tr><td>';

if (variableIsSite) {
	massiveReplaceString += '<div style = "position: relative; top: -12; left: 13;"><div style = "position: absolute;"><table border = "0" cellpadding = "" cellspacing = "0"><tr><td><img src = "'+ imgPath +'/'+ nlclass +'/images'+ lg +'/text-classname.gif" /></td>';
	if (!lg)
...
for (var printTreeID = 0; printTreeID < numberOfTrees; printTreeID++) {
	...
	//box top
	massiveReplaceString += '<td><table border = "0" cellpadding = "0" cellspacing = "0" height = "500px" width = "330px">';
	...
	while (talent[i] && talent[i][0] == printTreeID &&  i != (talent.length - 1)){
		...
		//{	
			...
			massiveReplaceString += '<table border = "0" cellspacing = "0" cellpadding = "0" align="center"><tr><td class = "treePadding">';
			massiveReplaceString += '<table border = "0" cellpadding = "15" cellspacing = "0">';
			...
			for (verticalCounter = 1; verticalCounter <= vertical; verticalCounter++)
			{
				...
				for (horizontalCounter = 1; horizontalCounter <= horizontal; horizontalCounter++)
				{
					...
					if (talent[i] && talent[i][3] == horizontalCounter && talent[i][4] == verticalCounter)
					{
						...
						{ 
							massiveReplaceString += '<span id = "requiresPoints'+ i +'" style = "color: red" class = "mySmall"><br>' + requiresRequires + ' '+ ((talent[i][4]*4)-4) +' '+ requiresPointsIn + ' ' + tree[talent[i][0]] +' '+ requiresTalents +'</span>';
						}
	...
	<tr>\
		...
		<td width="240px" nowrap class="tablebotbot">\
	...
	massiveReplaceString += '</td><td><img src = "'+ imgPath +'/includes/images/bot-box/bot-right.gif"></td></tr>';
...
massiveReplaceString += '<img src = "'+ pixelGif +'" height = "0" width = "300">';
...
//box bottom
massiveReplaceString += '<span style = "color: #ffffff;"><span style = "font-weight: bold;">'+ textToSave +'</span></span></span><br>';
